...
​	基于github的SDL2版本(realse-2.0.12)：[SDL2源码链接](https://github.com/libsdl-org/SDL/tree/release-2.0.12)。

### IDE编译运行

​	1、git clone -b master https://gitcode.com/openharmony-sig/ohos_sdl2.git；

​	2、DevEco Studio打开ohos-project日录，进行Migrate配置；

​	3、(可选)配置DevEco Studio的SDK路径(DevEco Studio 5.0.3.652自带SDK)如果需要单独配置，进入setting页面进行配置；
